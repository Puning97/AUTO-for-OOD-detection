...
from data_pre.online_loader import set_multi_loader
...
train_loader,val_loader,in_out_dataloader,in_clas=set_multi_loader(cfg.in_dataset,cfg.out_dataset,cfg.out_dataset2)
